...
// Founder photo: uploaded directly to the repo root by the client
const founderImg =
  "https://raw.githubusercontent.com/umangshah1811/Websitefigma/main/generated-image%20(5).png";
...
const coreValues = [
  { icon: Heart,      title: "Nurturing Care",  description: "We create a warm and supportive environment where every child feels safe, valued, and encouraged to grow.",                      accent: "#FF6B8A", bg: "from-rose-50 to-pink-50",    ring: "border-rose-100"    },
  { icon: BookMarked, title: "Joyful Learning", description: "We make learning engaging and meaningful through play, creativity, and hands-on discovery.",                                  accent: "#0047FF", bg: "from-blue-50 to-indigo-50",  ring: "border-blue-100"    },
  { icon: Shield,     title: "Safety First",    description: "We maintain a secure and caring space that gives families confidence and children the freedom to thrive.",                     accent: "#00A878", bg: "from-emerald-50 to-teal-50", ring: "border-emerald-100" },
  { icon: Users,      title: "Community",       description: "We foster strong partnerships among children, parents, and teachers to build a connected and caring community.",              accent: "#F59E0B", bg: "from-amber-50 to-yellow-50",  ring: "border-amber-100"   },
];

const whyUs = [
  { icon: GraduationCap, title: "Expert Teachers",      description: "Our caring and experienced educators create meaningful learning experiences for every stage of early childhood.",           accent: "#0047FF", bg: "bg-blue-50"    },
  { icon: Shield,        title: "Safe Environment",     description: "We maintain a secure, well-supervised space where children can learn, explore, and thrive with confidence.",               accent: "#00A878", bg: "bg-emerald-50" },
  { icon: BookOpen,      title: "Holistic Curriculum",  description: "Our balanced curriculum supports cognitive, social, emotional, and creative development through age-appropriate activities.", accent: "#7C3AED", bg: "bg-violet-50"  },
  { icon: Heart,         title: "Individual Attention", description: "With a thoughtful approach and supportive classrooms, each child receives the care and guidance they need to grow.",       accent: "#FF6B8A", bg: "bg-rose-50"    },
];
    ...
    <div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          {/* ── Founder ─────────────────────────────────────────────────────── */}
          <div
            className="mt-16 bg-gradient-to-br from-amber-50 to-yellow-50 rounded-3xl border border-[#D4AF37]/40 p-8 md:p-12"
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-5 gap-8 items-center">
              ...
              <div className="md:col-span-2 flex flex-col items-center gap-4">
                <div
                  className="w-44 h-44 md:w-56 md:h-56 rounded-full overflow-hidden flex-shrink-0"
                  style={{
                ...
                >
                  <img
                    src={founderImg}
                    alt="Mrs. Pooja Shah, Founder and Principal of Mother Care Pre-School Surat"
