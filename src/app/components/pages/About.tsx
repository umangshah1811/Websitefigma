        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-700 leading-relaxed">
              For over 15 years, we've been nurturing young minds and building bright futures in Surat. Our mission is to provide quality early childhood education in a safe, loving, and stimulating environment.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-4 leading-relaxed">
                Mother Care Pre-School was established with a vision to create an educational institution that prioritizes the holistic development of children. We believe that early childhood is a critical period that shapes a child's future.
              </p>
              <p className="text-lg text-gray-700 mb-4 leading-relaxed">
                Our founder recognized the need for a preschool that combines academic excellence with emotional nurturing. What started as a small center has grown into one of Surat's most trusted preschools, educating over 2000 children who have gone on to excel in their academic and personal lives.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                Today, we continue to uphold our founding principles while incorporating modern teaching methodologies and best practices in early childhood education.
              </p>
            </div>
            <div>
              <img src={teamImage} alt="Our caring teachers" className="rounded-3xl shadow-2xl w-full h-[500px] object-cover" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="bg-white rounded-3xl shadow-xl p-8">
              ...
              <p className="text-gray-700 leading-relaxed">To provide a nurturing, stimulating, and safe environment where children can explore, learn, and grow through play-based activities and structured learning. We aim to foster a love for learning that lasts a lifetime while developing essential social, emotional, and cognitive skills.</p>
            </div>
            <div className="bg-white rounded-3xl shadow-xl p-8">
              <div className="bg-yellow-500 text-white p-4 rounded-2xl inline-block mb-6"><Sparkles size={40} /></div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Our Vision</h3>
              <p className="text-gray-700 leading-relaxed">To be recognized as the leading early childhood education center in Surat, setting the standard for excellence in preschool education. We envision a future where every child who walks through our doors develops into a confident, curious, and compassionate individual ready for lifelong learning.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                <div key={index} className="flex gap-4 p-6 bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl hover:shadow-lg transition-shadow">
      ...
      <section className="py-16 bg-gradient-to-br from-[#0047FF] to-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/admissions#tour" className="bg-[#FFCC00] text-gray-900 px-8 py-4 rounded-full font-semibold hover:bg-[#FFD633] transition-all shadow-lg">Book a School Tour</Link>
            <Link to="/contact" className="bg-white text-[#0047FF] px-8 py-4 rounded-full font-semibold hover:bg-gray-100 transition-all shadow-lg">Contact Us</Link>
          </div>
        </div>
      </section>
    </div>
