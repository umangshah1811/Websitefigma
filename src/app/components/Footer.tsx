...
export function Footer() {
  /* Back to Top: hits window, documentElement and body for all scroll containers */
  const scrollToTop = () => {
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="flex items-center gap-3 mb-4">
                <img src={logo} alt="Mother Care Pre-School Logo" className="h-14 w-14 object-contain rounded-full" />
                <div>
              ...
              {/* Increased top margin for visual breathing room */}
            ...
            <div>
              ...
              {/* Map image also wrapped in directions link */}
